...
You must add the prompt that generated the code as a comment at the top of the file. Regarding the 80-character limit: if the prompt includes a link, you can leave it on its own line and Autograder will ignore that line; if it does not include a link, you can split it on multiple commented lines each under 80 characters (this is called "refilling", in case your text editor has it). If you used multiple prompts, please copy them all and mark them by number, e.g. "Prompt 1: ... Prompt 2: ...".
