...
When fixing the bug, your answer must match the use case:

- the number of pages in the solution slides has to be greater or equal to the number of pages in the original slides;

- the difference between the two must equal the length of the list with additional pages;
